...
// Create a geometry for the diamond & Icosahedron
...
function animate() {
  ...
  if (LeftClick) {
    group.rotation.x += 0.05 * (targetRotationY - group.rotation.x);
    group.rotation.y += 0.05 * (targetRotationX - group.rotation.y);
    group2.rotation.x += 0.05 * (targetRotationY - group2.rotation.x);
    group2.rotation.y += 0.05 * (targetRotationX - group2.rotation.y);
  } else {
